...
from flask_resource_chassis import ValidationError
...
class ChassisService:
    ...
    def update(self, entity):
        ...
        filters = {
            "is_deleted": False,
            primary_key.name: entity.__dict__.get(primary_key.name)
        }
        ...
        stm = entity.__table__.update().values(**update_vals).where(
            primary_key == entity.__dict__.get(primary_key.name))
